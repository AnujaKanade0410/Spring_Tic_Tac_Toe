...
public class GameLogic {
    ...
    static List<List<Position>> getWinningPositions() {
        ...
        winingPositions.add(List.of(new Position(1, 1), new Position(1, 2), new Position(1,3)));
        winingPositions.add(List.of(new Position(2, 1), new Position(2, 2), new Position(2,3)));
        winingPositions.add(List.of(new Position(3, 1), new Position(3, 2), new Position(3,3)));

        winingPositions.add(List.of(new Position(1, 1), new Position(2, 1), new Position(3,1)));
        winingPositions.add(List.of(new Position(1, 2), new Position(2, 2), new Position(3,2)));
        winingPositions.add(List.of(new Position(1, 3), new Position(2, 3), new Position(3,3)));

        winingPositions.add(List.of(new Position(1, 1), new Position(2, 2), new Position(3,3)));
        winingPositions.add(List.of(new Position(3, 1), new Position(2, 2), new Position(1,3)));
